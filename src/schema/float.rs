...
impl FloatSchema {
    pub fn equals(mut self, value: crate::value::Float) -> Self {
        self.0 = self.0.add(Equals::from(value.to_value()).into());
        self
    }

    pub fn options(mut self, options: &[crate::value::Float]) -> Self {
        self.0 = self
            .0
    ...
    pub fn min(mut self, min: f64) -> Self {
        self.0 = self
            .0
            .add(Min::from(crate::value::Number::from_f64(min)).into());
        self
    }
    ...
    pub fn max(mut self, max: f64) -> Self {
        self.0 = self
            .0
            .add(Max::from(crate::value::Number::from_f64(max)).into());
        self
    }
}
...
mod tests {
    ...
    #[test]
    fn validate_equals() {
        let schema = float().equals(crate::value::Float::from_f64(3.14));
        assert!(schema.validate(&3.14f64.to_value().into()).is_ok());
    ...
    fn validate_options() {
        let schema = float().options(&[
            crate::value::Float::from_f64(1.0),
            crate::value::Float::from_f64(2.5),
            crate::value::Float::from_f64(3.14),
        ]);
    ...
    fn validate_required_and_equals() {
        let schema = float()
            .required()
            .equals(crate::value::Float::from_f64(1.5));
